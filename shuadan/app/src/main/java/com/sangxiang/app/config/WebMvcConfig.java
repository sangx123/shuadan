...
//        registry.addInterceptor(new AdminInterceptor()).addPathPatterns("/admin/**").excludePathPatterns("/admin/login");
       ...
       // registry.addInterceptor(new FormTokenInterceptor()).addPathPatterns("/**");resetPassword
        registry.addInterceptor(new ApiInterceptor()).addPathPatterns("/api/**").excludePathPatterns("/test").excludePathPatterns("/api/index/resetPassword").excludePathPatterns("/api/index/register").excludePathPatterns("/api/index/login").excludePathPatterns("/api/index/resetPwd");
